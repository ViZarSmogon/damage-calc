...
const SV: TypeChart = extend(true, {}, SS, {
  ...
  Water: {Ice: 0.5, Stellar: 1},
  Electric: {Stellar: 1},
  Ice: {Stellar: 1},
  Flying: {Ice: 0.5, Stellar: 1},
  Bug: {Steel: 1, Fairy: 1, Stellar: 1},
  Poison: {Steel: 0.5, Stellar: 1},
  Ground: {Ice: 0.5, Ground: 0.5, Stellar: 1},
  Rock: {Grass: 0.5, Stellar: 1},
  Fighting: {Stellar: 1},
  Psychic: {Stellar: 1},
  Ghost: {Stellar: 1},
  Dragon: {Stellar: 1},
  Dark: {Bug: 0.5, Stellar: 1},
  Steel: {Steel: 1, Stellar: 1},
  Fairy: {Bug: 0.5, Stellar: 1},
  Stellar: {
    '???': 1,
  },
});
