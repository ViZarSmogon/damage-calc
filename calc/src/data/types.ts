...
const SV: TypeChart = extend(true, {}, SS, {
  '???': {Stellar: 1},
  Normal: {Dark: 2, Steel: 1, Stellar: 1},
  Grass: {Steel: 1, Stellar: 1},
  Fire: {Steel: 1, Stellar: 1},
  Water: {Electric: 0.5, Steel: 2, Stellar: 1},
  Electric: {Steel: 2, Stellar: 1},
  Ice: {Steel: 1, Stellar: 1},
  Flying: {Steel: 1, Stellar: 1},
  Bug: {Poison: 2, Steel: 1, Stellar: 1},
  Poison: {Bug: 2, Steel: 0.5, Stellar: 1},
  Ground: {Steel: 1, Stellar: 1},
  Rock: {Stellar: 1},
  Fighting: {Dark: 1, Steel: 0.5, Stellar: 1},
  Psychic: {Dark: 0.5, Steel: 1, Stellar: 1},
  Ghost: {Ghost: 1, Stellar: 1},
  Dragon: {Steel: 1, Stellar: 1},
  Dark: {Normal: 0.5, Fighting: 1, Dark: 2, Stellar: 1},
  Steel: {Fire: 1, Ice: 1, Steel: 0, Stellar: 1},
  Fairy: {Stellar: 1},
  Stellar: {
    '???': 1,
  },
