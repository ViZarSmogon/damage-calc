...
const GSC: TypeChart = extend(true, {}, RBY, {
  ...
  Ice: {Fire: 2, Dark: 1, Steel: 0.5},
  Flying: {Dark: 1, Steel: 0.5},
  Bug: {Poison: 2, Dark: 0.5, Steel: 0.5},
  Poison: {Bug: 1, Dark: 1, Steel: 0},
  Ground: {Dark: 1, Steel: 2},
  Rock: {Dark: 1, Steel: 0.5},
  Fighting: {Dark: 0.5, Steel: 2},
  Psychic: {Dark: 2, Steel: 0.5},
  Ghost: {Psychic: 0.5, Dark: 2, Steel: 0.5},
...
const SV: TypeChart = extend(true, {}, SS, {
  ...
  Rock: {Stellar: 1},
  Fighting: {Dark: 1, Steel: 2, Stellar: 1},
  Psychic: {Stellar: 1},
  Ghost: {Psychic: 2, Ghost: 1, Steel: 2, Stellar: 1},
  Dragon: {Stellar: 1},
  Dark: {Normal: 2, Steel: 2, Stellar: 1},
  Steel: {Ice: 1, Steel: 2, Stellar: 1},
  Fairy: {Stellar: 1},
  Stellar: {
    '???': 1,
  },
