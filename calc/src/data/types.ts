...
const SV: TypeChart = extend(true, {}, SS, {
  ...
  Bug: {Stellar: 1},
  Poison: {Stellar: 1},
  Ground: {Water: 0.5, Bug: 2, Ground: 0.5, Rock: 0.5, Steel: 1, Stellar: 1},
  Rock: {Water: 0.5, Bug: 2, Ground: 0.5, Rock: 0.5, Steel: 1, Stellar: 1},
  Fighting: {Rock: 1, Stellar: 1},
  Psychic: {Stellar: 1},
  Ghost: {Stellar: 1},
  Dragon: {Stellar: 1},
  Dark: {Stellar: 1},
  Steel: {Rock: 1, Stellar: 1},
  Fairy: {Stellar: 1},
  Stellar: {
    '???': 1,
  },
