...
const RBY: {[name: string]: MoveData} = {
  ...
  Haze: {bp: 0, category: 'Status', type: 'Water'},
  ...
  'Mirror Move': {bp: 0, category: 'Status', type: 'Normal'},
  Mist: {bp: 0, category: 'Status', type: 'Water'},
  'Night Shade': {bp: 1, type: 'Psychic'},
  'Petal Dance': {bp: 70, type: 'Grass'},
  'Pin Missile': {bp: 14, type: 'Grass', multihit: [2, 5]},
  'Poison Sting': {bp: 15, type: 'Dark'},
  ...
  'Rock Slide': {bp: 75, type: 'Fighting'},
  'Rock Throw': {bp: 50, type: 'Fighting'},
  ...
  Twineedle: {bp: 25, type: 'Grass', multihit: 2},
  Whirlwind: {bp: 0, category: 'Status', type: 'Normal'},
  'Wing Attack': {bp: 35, type: 'Normal'},
  ...
  'Poison Gas': {bp: 0, category: 'Status', type: 'Dark'},
  'Poison Powder': {bp: 0, category: 'Status', type: 'Dark'},
  'Sky Attack': {bp: 140, type: 'Normal'},
  'String Shot': {bp: 0, category: 'Status', type: 'Grass'},
  Surf: {bp: 95, type: 'Water'},
  'Tail Whip': {bp: 0, category: 'Status', type: 'Normal'},
  Toxic: {bp: 0, category: 'Status', type: 'Dark'},
  Flash: {bp: 0, category: 'Status', type: 'Normal'},
  Hypnosis: {bp: 0, category: 'Status', type: 'Psychic'},
  'Leech Life': {bp: 20, type: 'Grass', drain: [1, 2]},
  'Mega Drain': {bp: 40, type: 'Grass', drain: [1, 2]},
  'Vine Whip': {bp: 35, type: 'Grass'},
  Waterfall: {bp: 80, type: 'Water'},
  Tackle: {bp: 35, type: 'Normal'},
  'Acid Armor': {bp: 0, category: 'Status', type: 'Dark'},
  ...
  'Ice Beam': {bp: 95, type: 'Water'},
  Lick: {bp: 20, type: 'Psychic'},
...
const GSC_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  Bite: {type: 'Dark'},
  'Night Shade': {bp: 0},
  'Sand Attack': {type: 'Fighting'},
  'Seismic Toss': {bp: 0},
  'Sonic Boom': {bp: 0},
  'Super Fang': {bp: 0},
  'Wing Attack': {bp: 60},
  Aeroblast: {bp: 100, type: 'Normal'},
  ...
  'Destiny Bond': {bp: 0, category: 'Status', type: 'Psychic'},
  ...
  Nightmare: {bp: 0, category: 'Status', type: 'Psychic'},
  Outrage: {bp: 90, type: 'Dragon'},
  'Powder Snow': {bp: 40, type: 'Water'},
  ...
  Sandstorm: {bp: 0, category: 'Status', type: 'Fighting'},
  Sketch: {bp: 0, category: 'Status', type: 'Normal'},
  'Sleep Talk': {bp: 0, category: 'Status', type: 'Normal'},
  Spikes: {bp: 0, category: 'Status', type: 'Fighting'},
  Spite: {bp: 0, category: 'Status', type: 'Psychic'},
  ...
  'Ancient Power': {bp: 60, type: 'Fighting'},
  'Bone Rush': {bp: 25, type: 'Fighting', multihit: [2, 5]},
  ...
  'Spider Web': {bp: 0, category: 'Status', type: 'Grass'},
  ...
  'Fury Cutter': {bp: 10, type: 'Grass'},
  Magnitude: {bp: 0, type: 'Fighting'},
  ...
  'Hidden Power Bug': {bp: 70, type: 'Grass'},
  ...
  'Hidden Power Flying': {bp: 70, type: 'Normal'},
  'Hidden Power Ghost': {bp: 70, type: 'Psychic'},
  'Hidden Power Grass': {bp: 70, type: 'Grass'},
  'Hidden Power Ground': {bp: 70, type: 'Fighting'},
  'Hidden Power Ice': {bp: 70, type: 'Water'},
  'Hidden Power Poison': {bp: 70, type: 'Dark'},
  'Hidden Power Psychic': {bp: 70, type: 'Psychic'},
  'Hidden Power Rock': {bp: 70, type: 'Fighting'},
  ...
  Megahorn: {bp: 120, type: 'Grass'},
  'Metal Claw': {bp: 50, type: 'Steel'},
  'Mud-Slap': {bp: 20, type: 'Fighting'},
  Octazooka: {bp: 65, type: 'Water'},
  'Pain Split': {bp: 0, category: 'Status', type: 'Normal'},
  'Shadow Ball': {bp: 80, type: 'Psychic'},
  'Sludge Bomb': {bp: 90, type: 'Dark'},
...
const ADV_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  Astonish: {bp: 30, type: 'Psychic', makesContact: true},
  Block: {bp: 0, category: 'Status', type: 'Normal'},
  Bounce: {bp: 85, type: 'Normal', makesContact: true},
  ...
  Hail: {bp: 0, category: 'Status', type: 'Water'},
  'Icicle Spear': {bp: 10, type: 'Water', multihit: [2, 5]},
  ...
  'Rock Blast': {bp: 25, type: 'Fighting', multihit: [2, 5]},
  'Role Play': {bp: 0, category: 'Status', type: 'Psychic'},
  'Sand Tomb': {bp: 15, type: 'Fighting'},
  ...
  'Mud Sport': {bp: 0, category: 'Status', type: 'Fighting'},
  ...
  'Poison Fang': {bp: 50, type: 'Dark', makesContact: true},
  'Rock Tomb': {bp: 50, type: 'Fighting'},
  'Will-O-Wisp': {bp: 0, category: 'Status', type: 'Fire'},
  'Ice Ball': {bp: 30, type: 'Water', makesContact: true},
  'Sheer Cold': {bp: 0, type: 'Water'},
  ...
  'Signal Beam': {bp: 75, type: 'Grass'},
  'Silver Wind': {bp: 60, type: 'Grass'},
  'Aerial Ace': {bp: 60, type: 'Normal', makesContact: true},
  ...
  'Feather Dance': {bp: 0, category: 'Status', type: 'Normal'},
  Flatter: {bp: 0, category: 'Status', type: 'Dark'},
  'Frenzy Plant': {bp: 150, type: 'Grass'},
  Grudge: {bp: 0, category: 'Status', type: 'Psychic'},
  ...
  'Mud Shot': {bp: 55, type: 'Fighting'},
  'Poison Tail': {bp: 50, type: 'Dark', makesContact: true},
  'Shadow Punch': {bp: 60, type: 'Psychic', makesContact: true},
...
const DPP_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  Chatter: {bp: 60, type: 'Normal', isSound: true, category: 'Special'},
  ...
  Roost: {bp: 0, type: 'Normal'},
  'Stealth Rock': {bp: 0, type: 'Fighting'},
  'Sucker Punch': {
    bp: 80,
    type: 'Dark',
    priority: 1,
  ...
  Tailwind: {bp: 0, type: 'Normal'},
  'Toxic Spikes': {bp: 0, type: 'Dark'},
  ...
  'Air Slash': {bp: 75, type: 'Normal', category: 'Special'},
  'Aura Sphere': {bp: 90, type: 'Fighting', category: 'Special'},
  'Bug Buzz': {bp: 90, type: 'Grass', isSound: true, category: 'Special'},
  ...
  'Gunk Shot': {bp: 120, type: 'Dark', category: 'Physical'},
  'Gyro Ball': {
    bp: 0,
    type: 'Steel',
    makesContact: true,
  ...
  'Power Gem': {bp: 70, type: 'Fighting', category: 'Special'},
  ...
  'Mud Bomb': {bp: 65, type: 'Fighting', category: 'Special'},
  'Ominous Wind': {bp: 60, type: 'Psychic', category: 'Special'},
  Punishment: {
    bp: 0,
    type: 'Dark',
    makesContact: true,
  ...
  'Attack Order': {bp: 90, type: 'Grass', category: 'Physical'},
  ...
  'Earth Power': {bp: 90, type: 'Fighting', category: 'Special'},
  ...
  'Ice Shard': {bp: 40, type: 'Water', priority: 1, category: 'Physical'},
  'Iron Head': {
    bp: 80,
    type: 'Steel',
    makesContact: true,
  ...
  'Rock Polish': {bp: 0, type: 'Fighting'},
  'Rock Wrecker': {bp: 150, type: 'Fighting', category: 'Physical'},
  ...
  'Stone Edge': {bp: 100, type: 'Fighting', category: 'Physical'},
  'Thunder Fang': {
    bp: 65,
    type: 'Electric',
    makesContact: true,
...
const BW_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Frost Breath': {bp: 40, type: 'Water', willCrit: true, category: 'Special'},
  ...
  Hex: {bp: 50, type: 'Psychic', category: 'Special'},
  'Horn Leech': {
    bp: 75,
    type: 'Grass',
    drain: [1, 2],
  ...
  'Rage Powder': {bp: 0, type: 'Grass', priority: 3},
  'Relic Song': {
    bp: 75,
    type: 'Normal',
    isSound: true,
  ...
  'Wide Guard': {bp: 0, type: 'Fighting', priority: 3},
  ...
  'Clear Smog': {bp: 50, type: 'Dark', category: 'Special'},
  Coil: {bp: 0, type: 'Dark'},
  ...
  'Smack Down': {bp: 50, type: 'Fighting', category: 'Physical'},
  ...
  Venoshock: {bp: 65, type: 'Dark', category: 'Special'},
  'Wild Charge': {
    bp: 90,
    type: 'Electric',
    recoil: [1, 4],
...
const XY_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Misty Terrain': {bp: 0, type: 'Psychic'},
  'Mystical Fire': {
    bp: 65,
    type: 'Fire',
    category: 'Special',
  ...
  Powder: {bp: 0, type: 'Grass', priority: 1},
  'Spiky Shield': {bp: 0, type: 'Grass', priority: 4},
  'Thousand Arrows': {bp: 90, type: 'Fighting', target: 'allAdjacentFoes', category: 'Physical'},
  'Thousand Waves': {bp: 90, type: 'Fighting', target: 'allAdjacentFoes', category: 'Physical'},
  'Water Shuriken': {
    bp: 15,
    type: 'Water',
    multihit: [2, 5],
  ...
  Geomancy: {bp: 0, type: 'Psychic'},
  'Grassy Terrain': {bp: 0, type: 'Grass'},
  'Ion Deluge': {bp: 0, type: 'Electric', priority: 1},
  'Land\'s Wrath': {bp: 90, type: 'Fighting', target: 'allAdjacentFoes', category: 'Physical'},
  'Light of Ruin': {bp: 140, type: 'Psychic', recoil: [1, 2], category: 'Special'},
  'Oblivion Wing': {
    bp: 80,
    type: 'Normal',
    drain: [3, 4],
  ...
  'Aromatic Mist': {bp: 0, type: 'Psychic'},
  'Baby-Doll Eyes': {bp: 0, type: 'Psychic', priority: 1},
  Belch: {bp: 120, type: 'Dark', category: 'Special'},
  Boomburst: {
    bp: 140,
    type: 'Normal',
    isSound: true,
  ...
  'Dazzling Gleam': {bp: 80, type: 'Psychic', target: 'allAdjacentFoes', category: 'Special'},
  'Disarming Voice': {
    bp: 40,
    type: 'Psychic',
    isSound: true,
  ...
  'Fairy Lock': {bp: 0, type: 'Psychic'},
  'Fairy Wind': {bp: 40, type: 'Psychic', category: 'Special'},
  'Flower Shield': {bp: 0, type: 'Psychic'},
  ...
  Infestation: {bp: 20, type: 'Grass', makesContact: true, category: 'Special'},
  ...
  'Sticky Web': {bp: 0, type: 'Grass'},
  'Topsy-Turvy': {bp: 0, type: 'Dark'},
  'Trick-or-Treat': {bp: 0, type: 'Psychic'},
  'Venom Drench': {bp: 0, type: 'Dark', target: 'allAdjacentFoes'},
};
...
const SM_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Continental Crush': {bp: 1, type: 'Fighting', category: 'Physical', isZ: true},
  'Core Enforcer': {
    bp: 100,
    type: 'Dragon',
    target: 'allAdjacentFoes',
  ...
  'Floral Healing': {bp: 0, type: 'Psychic'},
  'Freezy Frost': {bp: 90, type: 'Water', category: 'Special', zp: 175},
  'Genesis Supernova': {
    bp: 185,
    type: 'Psychic',
    category: 'Special',
  ...
  'Guardian of Alola': {bp: 0, type: 'Psychic', category: 'Special', isZ: true},
  ...
  'Menacing Moonraze Maelstrom': {bp: 200, type: 'Psychic', category: 'Special', isZ: true},
  'Mind Blown': {
    bp: 150,
    type: 'Fire',
  ...
  'Nature\'s Madness': {bp: 0, type: 'Psychic', category: 'Special', zp: 100},
  'Never-Ending Nightmare': {bp: 1, type: 'Psychic', category: 'Physical', isZ: true},
  ...
  'Savage Spin-Out': {bp: 1, type: 'Grass', category: 'Physical', isZ: true},
  ...
  'Shore Up': {bp: 0, type: 'Fighting'},
  'Sinister Arrow Raid': {bp: 180, type: 'Psychic', category: 'Physical', isZ: true},
  'Sizzly Slide': {
    bp: 90,
    type: 'Fire',
    makesContact: true,
  ...
  'Sparkly Swirl': {bp: 90, type: 'Psychic', category: 'Special', zp: 175},
  'Splintered Stormshards': {bp: 190, type: 'Fighting', category: 'Physical', isZ: true},
  ...
  'Subzero Slammer': {bp: 1, type: 'Water', category: 'Physical', isZ: true},
  'Supersonic Skystrike': {bp: 1, type: 'Normal', category: 'Physical', isZ: true},
  'Tectonic Rage': {bp: 1, type: 'Fighting', category: 'Physical', isZ: true},
  'Throat Chop': {
    bp: 80,
    type: 'Dark',
    makesContact: true,
  ...
  'Toxic Thread': {bp: 0, type: 'Dark'},
  'Twinkle Tackle': {bp: 1, type: 'Psychic', category: 'Physical', isZ: true},
  'Zippy Zap': {
    bp: 50,
    type: 'Electric',
    willCrit: true,
  ...
  'Moongeist Beam': {bp: 100, type: 'Psychic', category: 'Special', zp: 180},
  'Photon Geyser': {
    bp: 100,
    type: 'Psychic',
    category: 'Special',
