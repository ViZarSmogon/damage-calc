...
const RBY: {[name: string]: MoveData} = {
  ...
  'Rock Slide': {bp: 75, type: 'Ground'},
  'Rock Throw': {bp: 50, type: 'Ground'},
...
const GSC_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  Sandstorm: {bp: 0, category: 'Status', type: 'Ground'},
  ...
  'Ancient Power': {bp: 60, type: 'Ground'},
  ...
  'Hidden Power Rock': {bp: 70, type: 'Ground'},
...
const ADV_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Rock Blast': {bp: 25, type: 'Ground', multihit: [2, 5]},
...
const DPP_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Power Gem': {bp: 70, type: 'Ground', category: 'Special'},
  ...
  'Rock Polish': {bp: 0, type: 'Ground'},
  'Rock Wrecker': {bp: 150, type: 'Ground', category: 'Physical'},
  ...
  'Stone Edge': {bp: 100, type: 'Ground', category: 'Physical'},
  'Thunder Fang': {
    bp: 65,
    type: 'Electric',
    makesContact: true,
...
const BW_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Wide Guard': {bp: 0, type: 'Ground', priority: 3},
  ...
  'Smack Down': {bp: 50, type: 'Ground', category: 'Physical'},
...
const SM_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Continental Crush': {bp: 1, type: 'Ground', category: 'Physical', isZ: true},
  'Core Enforcer': {
    bp: 100,
    type: 'Dragon',
    target: 'allAdjacentFoes',
  ...
  'Splintered Stormshards': {bp: 190, type: 'Ground', category: 'Physical', isZ: true},
