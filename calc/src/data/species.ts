...
const RBY: {[name: string]: SpeciesData} = {
  ...
  Arbok: {types: ['Dark'], bs: {hp: 60, at: 85, df: 69, sp: 80, sl: 65}, weightkg: 65},
  Arcanine: {
    types: ['Fire'],
  ...
  Marowak: {types: ['Fighting'], bs: {hp: 60, at: 80, df: 110, sp: 45, sl: 50}, weightkg: 45},
  Meowth: {
    types: ['Normal'],
  ...
  Muk: {types: ['Dark'], bs: {hp: 105, at: 105, df: 75, sp: 50, sl: 65}, weightkg: 30},
  Nidoking: {
    types: ['Dark', 'Fighting'],
  ...
  Pinsir: {types: ['Grass'], bs: {hp: 65, at: 125, df: 100, sp: 85, sl: 55}, weightkg: 55},
  Poliwag: {
    types: ['Water'],
...
const BW_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  'Rotom-Fan': {types: ['Electric', 'Normal']},
  'Rotom-Frost': {types: ['Electric', 'Water']},
...
const XY_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Azumarill: {types: ['Water', 'Psychic'], bs: {sa: 60}},
  Azurill: {types: ['Normal', 'Psychic']},
  ...
  Clefable: {types: ['Psychic'], bs: {sa: 95}},
  Clefairy: {types: ['Psychic']},
  Cleffa: {types: ['Psychic']},
  Cottonee: {types: ['Grass', 'Psychic']},
  Exploud: {bs: {sd: 73}},
  Gallade: {otherFormes: ['Gallade-Mega']},
  Garchomp: {otherFormes: ['Garchomp-Mega']},
  Gardevoir: {types: ['Psychic'], otherFormes: ['Gardevoir-Mega']},
  Gengar: {otherFormes: ['Gengar-Mega']},
  Gigalith: {bs: {sd: 80}},
  Glalie: {otherFormes: ['Glalie-Mega']},
  Golem: {bs: {at: 120}},
  Granbull: {types: ['Psychic']},
  ...
  Igglybuff: {types: ['Normal', 'Psychic']},
  Jigglypuff: {types: ['Normal', 'Psychic']},
  Jumpluff: {bs: {sd: 95}},
  ...
  Marill: {types: ['Water', 'Psychic']},
  Mawile: {types: ['Steel', 'Psychic'], otherFormes: ['Mawile-Mega']},
  ...
  Snubbull: {types: ['Psychic']},
  Staraptor: {bs: {sd: 60}},
  Steelix: {otherFormes: ['Steelix-Mega']},
  Stoutland: {bs: {at: 110}},
  Swampert: {otherFormes: ['Swampert-Mega']},
  Togekiss: {types: ['Psychic', 'Normal']},
  Togepi: {types: ['Psychic']},
  Togetic: {types: ['Psychic', 'Normal']},
  Tyranitar: {otherFormes: ['Tyranitar-Mega']},
  Unfezant: {bs: {at: 115}},
  Venusaur: {otherFormes: ['Venusaur-Mega']},
  Victreebel: {bs: {sd: 70}},
  Vileplume: {bs: {sa: 110}},
  Whimsicott: {types: ['Grass', 'Psychic']},
  Wigglytuff: {types: ['Normal', 'Psychic'], bs: {sa: 85}},
  'Aegislash-Blade': {
    types: ['Steel', 'Psychic'],
