...
const GSC_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Aerodactyl: {bs: {sa: 60, sd: 60}},
  Alakazam: {bs: {sa: 135, sd: 85}},
  Arbok: {bs: {sa: 65, sd: 65}},
  Arcanine: {bs: {sa: 80, sd: 80}},
  Articuno: {bs: {sa: 95, sd: 125}, gender: 'N'},
  Beedrill: {bs: {sa: 45, sd: 45}},
  Bellsprout: {bs: {sa: 70, sd: 30}},
  Blastoise: {bs: {sa: 85, sd: 85}},
  Bulbasaur: {bs: {sa: 65, sd: 65}},
  Butterfree: {bs: {sa: 80, sd: 80}},
  Caterpie: {bs: {sa: 20, sd: 20}},
  Chansey: {bs: {sa: 35, sd: 105}, nfe: true},
  Charizard: {bs: {sa: 85, sd: 85}},
  Charmander: {bs: {sa: 50, sd: 50}},
  Charmeleon: {bs: {sa: 65, sd: 65}},
  Clefable: {bs: {sa: 85, sd: 85}},
  Clefairy: {bs: {sa: 60, sd: 60}},
  Cloyster: {bs: {sa: 85, sd: 45}},
  Cubone: {bs: {sa: 40, sd: 40}},
  ...
  Dugtrio: {bs: {sa: 50, sd: 50}},
  Eevee: {bs: {sa: 45, sd: 65}},
  Ekans: {bs: {sa: 40, sd: 40}},
  Electabuzz: {bs: {sa: 85, sd: 85}},
...
const SM_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Dugtrio: {otherFormes: ['Dugtrio-Alola']},
  Eevee: {otherFormes: ['Eevee-Starter']},
  Exeggutor: {otherFormes: ['Exeggutor-Alola']},
